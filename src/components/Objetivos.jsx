...
const goalsData = [
  {
    id: 1,
    goal: "Aumentar cuota de mercado",
    target: 100,
    progress: 25,
    compliance: 25,
  },
  ...
  {
    id: 3,
    goal: "Expandirse a nuevos mercados",
    target: 100,
    progress: 80,
    compliance: 80,
  },
  {
    id: 4,
    goal: "Reducir costos operativos",
    target: 50000,
    progress: 20000,
    compliance: 40,
  },
  {
    id: 5,
    goal: "Mejorar satisfacción del cliente",
    target: 100,
    progress: 100,
    compliance: 100,
  },
  {
    id: 6, 
    goal: "Optimizar procesos internos", 
    target: 100,
    progress: 60,
    compliance: 60, 
  }
          ...
          <tbody>
            {goalsData.map((goal) => (
              <tr key={goal.id} className="border-t">
                ...
                <td
                  className={`px-4 py-2 ${
                    getStatus(goal.compliance) === "Crítico"
                      ? "text-red-500"
                      : getStatus(goal.compliance) === "Aceptable"
                      ? "text-orange-500"
                      : "text-green-500"
                  }`}
                >
